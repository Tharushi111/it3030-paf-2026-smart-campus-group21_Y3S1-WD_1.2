import { FiBox, FiMapPin, FiUsers, FiImage } from "react-icons/fi";
  ...
  return (
    <div className="group overflow-hidden rounded-3xl border border-orange-100 bg-white shadow-md transition-all hover:-translate-y-1 hover:border-orange-300 hover:shadow-xl">
      ...
      <div className="p-5">
        ...
        <button className="mt-4 w-full rounded-xl bg-orange-100 py-2 text-sm font-medium text-orange-700 transition hover:bg-orange-200">
          View Details
        </button>
      </div>
    </div>
