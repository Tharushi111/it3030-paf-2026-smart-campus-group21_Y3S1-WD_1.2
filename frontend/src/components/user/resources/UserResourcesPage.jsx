    ...
    <div className="space-y-8">
      ...
      <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-slate-950 via-blue-950 to-indigo-950 p-8 text-white shadow-xl border border-orange-500/20">
        ...
        <div className="relative">
          <h1 className="text-4xl font-bold">Available Resources</h1>
          <p className="mt-2 text-orange-100">
            Explore campus facilities, rooms, labs, and equipment available for use.
          </p>
        </div>
      </div>
      ...
      />
      <UserResourceList resources={filteredResources} loading={loading} />
    </div>
  );
}